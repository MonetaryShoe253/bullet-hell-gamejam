...
const ENEMIES: Array[Dictionary] = [
	...
	},
	{
		...
		"projectile_scene": SlimeProjectile,
		"theme": DungeonGenerator.RoomTheme.NONE, "min_level": 2,
	...
	{
		"id": &"burger_heavy", "scene": BurgerScene,
		"projectile_scene": BurgerProjectile,
		"theme": DungeonGenerator.RoomTheme.BURGER, "min_level": 2,
		"cost": 2.6, "weight": 0.55, "role": SpawnRole.FRONTLINE,
		"color": Color(1.0, 0.35, 0.35, 1),
		"health": 35.0, "damage": 7.0, "move_speed": 50.0,
		"fire_rate": 1.1, "money_reward": 7,
		"shot_pattern": Enemy.ShotPattern.SPREAD,
		"movement_pattern": Enemy.MovementPattern.CHASE,
	},
	{
	...
	{
		"id": &"taco_heavy", "scene": TacoScene,		
		"projectile_scene": TacoProjectile,
		"theme": DungeonGenerator.RoomTheme.TACO, "min_level": 2,
		"cost": 2.6, "weight": 0.55, "role": SpawnRole.FLANKER,
		"color": Color(1.0, 0.35, 0.35, 1),
		"health": 26.0, "damage": 7.0, "move_speed": 100.0,
		"fire_rate": 0.9, "money_reward": 7,
		"shot_pattern": Enemy.ShotPattern.BURST,
		"movement_pattern": Enemy.MovementPattern.STRAFE,
	},
	{
	...
	{
		"id": &"pizza_heavy", "scene": PizzaScene,
		"projectile_scene": PizzaProjectile,
		"theme": DungeonGenerator.RoomTheme.PIZZA, "min_level": 4,
		"cost": 2.6, "weight": 0.55, "role": SpawnRole.BACKLINE,
		"color": Color(1.0, 0.35, 0.35, 1),
		"health": 22.0, "damage": 10.0, "move_speed": 125.0,
		"fire_rate": 0.8, "money_reward": 7,
		"shot_pattern": Enemy.ShotPattern.SINGLE,
		"movement_pattern": Enemy.MovementPattern.KITE,
	},
]
